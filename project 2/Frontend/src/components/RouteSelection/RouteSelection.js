        ...
        <div className="container">
            <div>
                <nav className="mb-4 navbar navbar-expand-lg navbar-dark bg-unique hm-gradient">
                    <a href="/#" className="navbar-brand Company-Log" onClick={(e) => handleLogoClick(e)}>GO TICKET</a>
            ...
            <div>
                <ul className="nav nav-pills">
                    ...
                    <li className="nav-item">
                        <a className="nav-link" data-toggle="pill" href="#menu3">Bus Info</a>
                    </li>
                    <li className="nav-item">
                        <a className="nav-link" data-toggle="pill" href="#menu4">Inquiry Form</a>
                    </li>
                </ul>
                ...
                <div className="tab-content">
                    ...
                    <div className="tab-pane container fade mn-box" id="menu3"><BusInfo /></div> 
                    <div className="tab-pane container fade mn-box" id="menu4"><InquiryForm /></div> 
                </div>
            </div>
